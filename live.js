(function () {
  ...
  function render() {
    ...
    $('tbl').innerHTML =
      ...
      ` &middot; waiting to fill ${pend.length} &middot; ${r.scanning ? 'scanning now...' : 'auto-scan about every 25 min'}${r.scan_error ? ' <b class=loss>' + r.scan_error + '</b>' : ''}</p>` + sess +
